...
public class MainApp extends Application {
    ...
    /**
     * Бібліотека для зберігання книг.
     */
    ...
    public void start(Stage stage) {
        ...
        findButton.setOnAction(event -> {
            ...
            detailsArea.setText(buildFullBookInfo(book, library.getQuantityForBook(book)));
        });
     ...
     */
    private String buildFullBookInfo(Book book, int quantity) {
